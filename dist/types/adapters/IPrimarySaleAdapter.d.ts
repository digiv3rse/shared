...
import { NFTContractObject, PRIMARY_SALE_SOURCES } from "../nft/NFTContractObject";
export interface IPrimarySaleAdapter {
    ...
    purchase(quantity: BigNumberish, amount: BigNumberish): Promise<ContractTransaction>;
