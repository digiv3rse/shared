...
export interface IMarketAdapter {
    ...
    placeBid(nft: NFTObject, amount: BigNumberish): Promise<ContractTransaction | boolean>;
    fillAsk(nft: NFTObject, finder: BigNumberish): Promise<ContractTransaction | boolean>;
